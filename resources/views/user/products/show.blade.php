        ...
        <div class="max-w-1000px mx-auto">
            <div class="p-5">
                <a href="{{ route('user.products.index')}}"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 gap-2 w-[200px]">
                    Back to Products
                </a>
            </div>
            <div class="bg-white rounded-lg shadow-lg p-5 flex items-start gap-4">
                ...
                <div>
                    ...
                    <a href="/buy-now/{{$product->id}}"
                        class="inline-flex bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 items-center gap-2">
